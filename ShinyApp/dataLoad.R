...
hs_data <- read.csv("~/Downloads/Git/PIT-DSC-STEM-Inequality/data/2018_HS_Data.csv")
ms_df <- read_excel('~/Downloads/ratiochange.xlsx')
elem_data <- read_excel("~/Downloads/elementarymapdata.xlsx")
